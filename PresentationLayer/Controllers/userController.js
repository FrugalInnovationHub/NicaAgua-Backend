...
function UserController(app) {
    ...
    app.post('/user/otp/request', PermissionMiddleWare.isAuthenticated, async (req, res) => {
    ...
    app.post('/user/otp/verify', PermissionMiddleWare.isAuthenticated, async (req, res) => {
        // Fetch data from request body
        const destinationNumber = req.body.mobile;
